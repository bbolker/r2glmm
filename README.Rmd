...
The most up-to-date version of the `r2glmm` package is available on Github. To install the package from Github, after installing the `remotes` package, run the following code from the R console:

```{r, eval=FALSE}
remotes::install_github('bcjaeger/r2glmm')
```

Alternatively, there is a version of the package available on CRAN. To install the package from CRAN, run the following code from the R console:
